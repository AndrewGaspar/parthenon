...
struct NeighborIndexes { // aggregate and POD
  ...
  // aggregate. This struct's implicitly-defined or defaulted default ctor is trivial,
  // implying that NeighborIndexes is a trivial type. Combined with standard layout -->
  // POD. Advantages:
