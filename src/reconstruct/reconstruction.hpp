...
class Reconstruction {
 public:
  ...
  bool characteristic_projection; // reconstruct on characteristic or primitive hydro
                                  // vars
  bool uniform[3];
  ...
  void LeftEigenmatrixDotVector(const int ivx,
                                const int il,
                                const int iu,
                                const AthenaArray<Real> &b1,
                                const AthenaArray<Real> &w,
                                AthenaArray<Real> &vect);
  void RightEigenmatrixDotVector(const int ivx,
                                 const int il,
                                 const int iu,
                                 const AthenaArray<Real> &b1,
                                 const AthenaArray<Real> &w,
  ...
  void PiecewiseLinearX1(const int k,
                         const int j,
                         const int il,
                         const int iu,
                         const AthenaArray<Real> &w,
  ...
  void PiecewiseLinearX2(const int k,
                         const int j,
                         const int il,
                         const int iu,
                         const AthenaArray<Real> &w,
  ...
  void PiecewiseLinearX3(const int k,
                         const int j,
                         const int il,
                         const int iu,
                         const AthenaArray<Real> &w,
  ...
  void PiecewiseParabolicX1(const int k,
                            const int j,
                            const int il,
                            const int iu,
                            const AthenaArray<Real> &w,
  ...
  void PiecewiseParabolicX2(const int k,
                            const int j,
                            const int il,
                            const int iu,
                            const AthenaArray<Real> &w,
  ...
  void PiecewiseParabolicX3(const int k,
                            const int j,
                            const int il,
                            const int iu,
                            const AthenaArray<Real> &w,
