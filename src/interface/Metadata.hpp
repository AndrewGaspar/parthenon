...
class Metadata {
 public:
  ...
  void setIntensive(const bool a) {doBit(intensive, a);}  ///< Set intensive or
  extensive void setRestart(const bool a)   {doBit(restart, a);}    ///< Set IO /
  restart void setGraphics(const bool a)  {doBit(graphics, a);}   ///< Set IO / graphics
