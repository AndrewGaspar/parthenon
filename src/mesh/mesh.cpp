...
Mesh::Mesh(ParameterInput *pin,
    ...
    : // public members:
      ...
      nbdel(), step_since_lb(), gflag(), materials(materials), physics(physics),
      // private members:
      ...
      UserSourceTerm_{}, UserTimeStep_{}, ViscosityCoeff_{}, ConductionCoeff_{},
      FieldDiffusivity_{}, pblock(nullptr) {
