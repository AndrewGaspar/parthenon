    ...
    if (CLANG_FORMAT)
        ...
        foreach(SOURCE ${TARGET_SOURCES})
            if (IS_ABSOLUTE ${SOURCE})
                list(APPEND TARGET_SOURCES_ABSOLUTE ${SOURCE})
            else()
                list(APPEND TARGET_SOURCES_ABSOLUTE "${CMAKE_CURRENT_SOURCE_DIR}/${SOURCE}")
            endif()
        endforeach()
        add_custom_target(format-${TARGET} ${CLANG_FORMAT} -i ${TARGET_SOURCES_ABSOLUTE})
